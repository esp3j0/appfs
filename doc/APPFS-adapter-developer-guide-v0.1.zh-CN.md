...
2. 适配器要求：`doc/APPFS-adapter-requirements-v0.1.zh-CN.md`
3. 结构与桥接映射：`doc/APPFS-adapter-structure-mapping-v0.1.zh-CN.md`
4. 本文：实现路径与排障
5. 一致性与测试定义：
   - `doc/APPFS-conformance-v0.1.zh-CN.md`
   - `doc/APPFS-contract-tests-v0.1.zh-CN.md`
6. 兼容性矩阵：
   - `doc/APPFS-compatibility-matrix-v0.1.zh-CN.md`
